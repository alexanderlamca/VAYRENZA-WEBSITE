(() => {
  ...
  const translations = {
    ...
    'zh-CN': {
      ...
      '2026 CORE COLLECTION':'2026 核心系列','48 SKUs. One coherent system.':'48 个 SKU，一个完整统一的系统。','A curated architecture of premium hanger forms, materials, finishes and applications for global B2B customers.':'为全球 B2B 客户打造经过精心规划的高端衣架体系，涵盖造型、材料、表面处理与应用场景。','VZ-S SERIES':'VZ-S 系列','SUIT & SHIRT':'西装与衬衫','Refined silhouettes engineered for professional wardrobes and premium retail.':'以精致轮廓满足专业衣橱与高端零售陈列需求。','VZ-T SERIES':'VZ-T 系列','TROUSER & SKIRT':'长裤与半裙','Purpose-built forms balancing grip, presentation and space efficiency.':'以专门设计兼顾稳固夹持、陈列效果与空间效率。','VZ-P SERIES':'VZ-P 系列','PREMIUM & SPECIALTY':'高端与专业系列','Signature solutions for hospitality, luxury retail and bespoke programs.':'面向酒店、奢华零售及专属定制项目的标志性解决方案。',
      'GLOBAL B2B SOLUTIONS':'全球 B2B 解决方案','Built around your business.':'围绕您的业务而打造。','FASHION & RETAIL':'时尚与零售','Consistent presentation across stores, collections and markets.':'在不同门店、系列与市场中保持统一的品牌陈列。','HOSPITALITY':'酒店与服务业','Durable hanger programs for hotels, resorts and professional wardrobes.':'为酒店、度假村及专业衣橱提供耐用可靠的衣架项目。','GARMENT MANUFACTURING':'服装制造','Reliable systems for factories, showrooms and export programs.':'为工厂、展厅及出口项目提供稳定可靠的衣架系统。','OEM / ODM':'OEM / ODM','Custom dimensions, materials, finishes, branding and packaging.':'支持尺寸、材料、表面处理、品牌标识及包装定制。',
